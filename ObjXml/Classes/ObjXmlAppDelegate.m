...
- (void)connection:(NSURLConnection *)connection didFailWithError:(NSError *)error {
	[ OO_AUTORELEASE([[UIAlertView alloc] initWithTitle:@"Fetch Error"
...
- (UITableViewCell *)tableView:(UITableView *)aTableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
        cell = OO_AUTORELEASE([[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault
                                       reuseIdentifier:CellIdentifier]);
		[[cell contentView] addSubview:[prototype copyView]];
    }
	...
	[OOMetaData bindRecord:rows[indexPath.row] toView:[cell contentView] delegate:self];
    return cell;
}
