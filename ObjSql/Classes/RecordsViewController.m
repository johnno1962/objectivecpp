...
- (void)didSelect:(id)record {
	...
	OO_RELEASE( newRootViewController );
}

- (void)viewDidDisappear:(BOOL)animated {	
	if ( [editButton.title isEqualToString:@"Save"] )
		[ OO_AUTORELEASE( ([[UIAlertView alloc] initWithTitle:self.title message:@"Discard Edits?" delegate:self
						   cancelButtonTitle:@"Save" otherButtonTitles:@"Discard", nil]) ) show];
}
