...
@interface Authors : _Authors {
@public
	OOString au_name; // derived field populated when record loads
	NSString *zip; // derived field accessed by selector on demand
}
