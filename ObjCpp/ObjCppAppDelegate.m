...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {
	...
	if ( allTests ) {
		...
		OOExpect("INIT COPY RETAIN INIT RETAIN DESTRUCT RELEASE INIT RETAIN INIT RETAIN DESTRUCT RELEASE "
				 "INIT RETAIN INIT RETAIN INIT RETAIN INIT RETAIN INIT RETAIN DESTRUCT RELEASE DESTRUCT RELEASE "
				 "DESTRUCT RELEASE DESTRUCT RELEASE INIT RETAIN INIT RETAIN DESTRUCT RELEASE RETAIN RELEASE "
                 "DESTRUCT RELEASE DESTRUCT RELEASE DESTRUCT RELEASE DESTRUCT RELEASE" );
